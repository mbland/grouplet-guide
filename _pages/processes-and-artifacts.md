...
high-level strategic objectives that support the team's overall
...
- **O: Respond to the automated testing needs and priorities of products.**
...
responsibilities as defined in the [two-pager](#two-pager) give prospective
[recruits](#recruiting) a sense that the team is (or will become) well-organized
and efficient, while keeping the actual titles fun sends a message that the
group is not about piling additional work onto people for the sake of the
...
the [kick-off meeting](#kick-off), and explain this: _**The grouplet's long-term
...
"[MacGuffin][]" is the film industry term for an object that drives the action
of the plot. In _Pulp Fiction_, it's Marsellus Wallace's suitcase. In _Raiders
of the Lost Ark_, it's the Ark of the Covenant. It's handy to have a MacGuffin
at the outset of the grouplet as well.
...
and publish it at least one day prior to each meeting to give people an idea of
the week's business and to provide the opportunity to put new items on the
agenda. To make the best use of everyone's time, the organizers should impress
upon members that everyone should come prepared to discuss the items for which
they're responsible.
...
behind the key results component of the [Objectives and Key Results](#okrs)
process. Create a table with three columns:
